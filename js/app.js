...
function showPaperDetails(paper, paperIndex) {
  ...
  const paperUrl = paper.url.replace('abs', 'pdf');
  const prompt = `请你阅读这篇论文 ${paperUrl}，并按以下结构总结：1. 问题：该研究解决了什么问题？有何意义？2. 相关工作：现有方法有哪些？存在什么不足？3. 方法：作者提出了什么方法或框架？核心思路是什么？4. 实验：使用了哪些数据集？比较了哪些方法？评价指标？5. 结果：主要发现是什么？是否优于现有方法？6. 结论：研究贡献有哪些？未来可如何拓展？7. 摘要：请整体概括全文，简洁明了，适合快速了解精华内容。`;
